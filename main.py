...
# output_directory = path_to_folder
...
for idx, timestamp in enumerate(headshot_timestamp):
    video = VideoFileClip(video_path).subclip(timestamp-2, timestamp+2)
...
concat_clip.write_videofile('hightlight.mp4', codec="libx264", audio=False)
